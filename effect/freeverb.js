// from https://github.com/Tonejs/Tone.js/blob/master/Tone/effect/Freeverb.js
var wrap = require("../wrap")
module.exports = wrap([
  require("../component/lowpass-comb-filter"),
  require("./stereo-effect"),
  require("../signal/signal"),
  require("../component/split"),
  require("../component/merge"),
  require("../signal/scale-exp")
], function (Tone){
